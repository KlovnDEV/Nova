...
DP.Emotes = {
   ...
   ["incar"] = {"anim@amb@code_human_in_car_idles@arm@generic@ds@base", "idle", "In car", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
...
-----------------------------------------------------------------------------------------------------------
   ...
   ["jackhummer"] = {"Scenario", "WORLD_HUMAN_CONST_DRILL", "Jackhummer"},
...
DP.PropEmotes = {
   ...
   ["policebadge"] = {"random@hitch_lift", "idle_f", "xPolicebadge", AnimationOptions =
   {
       Prop = "leb_prop_lspd_badge",
       PropBone = 57005,
       PropPlacement = {0.11, 0.0, -0.06, 87.0, -90.0, 180.0},
       --
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["passport"] = {"random@hitch_lift", "idle_f", "xPassport", AnimationOptions =
   {
       Prop = "prop_passport_01",
       PropBone = 57005,
       PropPlacement = {0.17, 0.06, -0.02, 80.0, -90.0, 180.0},
       --
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["Trost"] = {"move_characters@lester@std_caneup", "move_characters@lester@std_caneup", "xTrost", AnimationOptions =
   {
       Prop = "prop_cs_walking_stick",
       PropBone = 57005,
       PropPlacement = {0.13, 0.04, -0.03, 10.0, -80.0, 150.0},
       --
    --    EmoteLoop = true,
    --    EmoteMoving = true,
   }},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["revivekit"] = {"missheistdocksprep1hold_cellphone", "static", "Набор первой помощи", AnimationOptions =
   {
   ...
   ["mobile_cad"] = {"missfam4", "base", "mobile_cad", AnimationOptions =
   {
       Prop = 'leb_prop_tabletnova01',
       PropBone = 36029,
       PropPlacement = {0.16, 0.08, 0.1, -20.0, -50.0, 0.0},
       EmoteMoving = true,
       EmoteLoop = true
   }},
   ["mobile_cad2"] = {"missfam4", "base", "mobile_cad2", AnimationOptions =
   {
       Prop = 'leb_prop_tabletnova02',
       PropBone = 36029,
       PropPlacement = {0.18, 0.10, 0.11, -50.0, -100.0, 280.0},
       EmoteMoving = true,
       EmoteLoop = true
   }},
