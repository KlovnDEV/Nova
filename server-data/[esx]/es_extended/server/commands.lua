...
ESX.RegisterCommand('emote', 'admin', function(xPlayer, args, showError) -- Анимация
	TriggerClientEvent('admin_commands:emote', xPlayer.source, args.dict, args.anim)
end, false, {help = "Проигрывает анимацию", validate = false, arguments = {
	{name = 'dict', help = 'База', type = 'any'},
	{name = 'anim', help = 'Анимация', type = 'any'}
}})
