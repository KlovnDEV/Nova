...
Config._Interactables = {}

for key, value in pairs(Config.Interactables) do
    Config._Interactables[GetHashKey(value)] = true
end

Config.Interactables = Config._Interactables
