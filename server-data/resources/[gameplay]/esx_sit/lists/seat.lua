Config.Sitable = {
	...
	prop_off_chair_05 			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.4, forwardOffset = 0.0, leftOffset = 0.0},
    ...
    v_med_cor_medstool          = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.6, forwardOffset = 0.0, leftOffset = 0.0},
    bkr_prop_biker_boardchair01 = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.0, leftOffset = 0.0},
    gr_prop_gr_chair02_ped      = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, leftOffset = 0.0},
    apa_mp_h_din_chair_04       = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
    apa_mp_h_din_chair_12       = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, leftOffset = 0.0},
    ...
    v_med_whickerchair1         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, leftOffset = 0.0},
    imp_prop_impexp_offchair_01a = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.0, leftOffset = 0.0},
    ex_mp_h_stn_chairarm_24     = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.0, leftOffset = 0.0},
    ...
    hei_heist_stn_sofa2seat_06  = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, leftOffset = 0.0},
